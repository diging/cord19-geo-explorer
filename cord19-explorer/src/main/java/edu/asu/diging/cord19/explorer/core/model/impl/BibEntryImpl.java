...
public class BibEntryImpl implements BibEntry {
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setRefId(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setTitle(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setAuthors(java.util.
     * List)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setVenue(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setVolume(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setIssn(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setPages(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.BibEntry#setOtherIds(java.util
     * .Map)
     */
    @Override
