...
public class LocationMatchImpl implements LocationMatch {
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.LocationMatch#getLocationName(
     * )
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.LocationMatch#setLocationName(
     * java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.LocationMatch#setStart(int)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.LocationMatch#getProbability()
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.LocationMatch#setProbability(
     * double)
     */
    @Override
     ...
     * 
     * @see
     * edu.asu.diging.cord19.explorer.core.model.impl.LocationMatch#setType(java.
     * lang.String)
     */
    @Override
